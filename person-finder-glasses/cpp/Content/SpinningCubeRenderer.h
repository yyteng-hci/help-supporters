...
namespace HolographicFaceTracker
{
    ...
    public:
        ...
        void Render();
        HRESULT CreateNearbyAudio();
        float FindNearbyBound( Windows::Foundation::Numerics::float3 target);
    ...
    private:
        ...
        // For rendering spatial audio.
        AudioFileReader                                 m_audioFile;
        AudioFileReader                                 m_nearbyFile;
        Microsoft::WRL::ComPtr<IXAudio2>                m_xaudio2;
        IXAudio2SourceVoice*                            m_sourceVoice = nullptr;
        IXAudio2SourceVoice*                            m_nearbyVoice = nullptr;
        ...
        Windows::Foundation::Numerics::float3           m_targetPosition = { 0.f, 0.f, 0.f };
